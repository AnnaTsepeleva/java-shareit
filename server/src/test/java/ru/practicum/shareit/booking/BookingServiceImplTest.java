...
class BookingServiceImplTest {
    ...
    void shouldGetUserBookingsWithAll() {
        ...
        List<GetBookingDto> bookings = bookingService.getUserBookings(1L, State.ALL, 1, 5);
    ...
    void shouldGetExceptionWithGetUserBookingsWithAll() {
        ...
        final NotFoundException exception = Assertions.assertThrows(
                NotFoundException.class,
                () -> bookingService.getUserBookings(1L, State.ALL, 1, 5)
        );
    ...
    void shouldGetUserBookingsWithCurrent() {
        ...
        List<GetBookingDto> bookings = bookingService.getUserBookings(1L, State.CURRENT, 1, 5);
    ...
    void shouldGetUserBookingsWithPast() {
        ...
        List<GetBookingDto> bookings = bookingService.getUserBookings(1L, State.PAST, 1, 5);
    ...
    void shouldGetUserBookingsWithReject() {
        ...
        List<GetBookingDto> bookings = bookingService.getUserBookings(1L, State.REJECTED, 1, 5);
    ...
    void shouldGetOwnerBookingsWithAll() {
        ...
        List<GetBookingDto> bookings = bookingService.getOwnerBookings(1L, State.ALL, 1, 5);
    ...
    void shouldGetExceptionWithGetOwnerBookingsWithAll() {
        ...
        final NotFoundException exception = Assertions.assertThrows(
                NotFoundException.class,
                () -> bookingService.getOwnerBookings(1L, State.ALL, 1, 5)
        );
    ...
    void shouldGetOwnerBookingsWithCurrent() {
        ...
        List<GetBookingDto> bookings = bookingService.getOwnerBookings(1L, State.CURRENT, 1, 5);
    ...
    void shouldGetOwnerBookingsWithPast() {
        ...
        List<GetBookingDto> bookings = bookingService.getOwnerBookings(1L, State.PAST, 1, 5);
    ...
    void shouldGetOwnerBookingsWithFuture() {
        ...
        List<GetBookingDto> bookings = bookingService.getOwnerBookings(1L, State.FUTURE, 1, 5);
    ...
    void shouldGetOwnerBookingsWithWaiting() {
        ...
        List<GetBookingDto> bookings = bookingService.getOwnerBookings(1L, State.WAITING, 1, 5);
    ...
    void shouldGetOwnerBookingsWithReject() {
        ...
        List<GetBookingDto> bookings = bookingService.getOwnerBookings(1L, State.REJECTED, 1, 5);
