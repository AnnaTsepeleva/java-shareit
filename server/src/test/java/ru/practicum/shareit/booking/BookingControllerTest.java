...
class BookingControllerTest {
    ...
    void shouldGetBookingWithGetUserBookings() throws Exception {
        ...
        verify(bookingService, times(1)).getUserBookings(anyLong(), any(State.class), anyInt(), anyInt());
    }
    ...
    void shouldGetBookingWithGetOwnerBookings() throws Exception {
        ...
        mockMvc.perform(get("/bookings/owner")
                ...
                .andExpect(jsonPath("$.[0].id").value(2L))
                .andExpect(jsonPath("$.[19].id").value(21L));
        verify(bookingService, times(1)).getOwnerBookings(anyLong(), any(State.class), anyInt(), anyInt());
    }
}