...
public class BookingIntegrationTest {
    ...
    void shouldGetUserBookings() {
        ...
        List<GetBookingDto> bookings = bookingService.getUserBookings(1L, State.ALL,1, 3);
    ...
    void shouldGetOwnerBookings() {
        ...
        List<GetBookingDto> bookings = bookingService.getOwnerBookings(1L, State.ALL,1, 3);
